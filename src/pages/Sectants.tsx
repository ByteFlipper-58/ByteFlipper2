...
const Sectants = () => {
  return (
    <div className="min-h-screen pt-20 bg-dark-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-[url('https://images.unsplash.com/photo-1478760329108-5c3ed9d495a0?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center opacity-5" />
      <div className="fixed inset-0 bg-gradient-to-b from-dark-100 via-transparent to-dark-100" />
      ...
      <section className="relative py-20">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-dark-100/50" /> {/* This fixes the glow cutoff */}
        </div>
        ...
        >
          ...
          <div className="relative">
            <motion.div
              ...
              className="relative"
            >
              <Flame className="w-16 h-16 mx-auto mb-6 text-primary-end" />
              <motion.div
            ...
            <motion.h1
              ...
              animate={{ textShadow: ['0 0 20px rgba(239, 17, 111, 0.5)', '0 0 40px rgba(239, 17, 111, 0.3)', '0 0 20px rgba(239, 17, 111, 0.5)'] }}
              transition={{ duration: 2, repeat: Infinity }}
            >
              The Inner Circle
            </motion.h1>
      ...
      <section className="relative py-20 px-4">
        <div className="absolute inset-0 bg-dark-100/90" /> {/* Background overlay */}
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Hover effect with skull icon */}
              <motion.div
                initial={{ opacity: 0 }}
                whileHover={{ opacity: 1 }}
                className="absolute -top-4 -right-4 z-10"
              >
                <Skull className="w-8 h-8 text-primary-end" />
              </motion.div>

              <div className="absolute inset-0 bg-gradient-to-r from-primary-start to-primary-end opacity-20 group-hover:opacity-100 transition-opacity duration-500 rounded-xl" />
              
              <div className="relative bg-dark-200/90 backdrop-blur-sm m-[1px] rounded-xl p-8">
